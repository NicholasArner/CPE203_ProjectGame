...
public abstract class GoalFinder extends MovingEntity{
    ...
    private List<Point> calculatePath(WorldModel world, Point destPos){
        ...
        return strategy.computePath(getPosition(), destPos, p-> !world.isOccupied(p) & world.withinBounds(p), MovingEntity::neighbors, PathingStrategy.DIAGONAL_CARDINAL_NEIGHBORS);
    }
